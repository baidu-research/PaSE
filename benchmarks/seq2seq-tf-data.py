...
class LSTMCell(keras.layers.Layer):
    ...
    def build(self, input_shape):
        w_shape = [(2 + self.attention) * self.num_units, 4 * self.num_units]
...
class Model():
    def __init__(self, args, params, src_vocab_size, tgt_vocab_size):
        ...
        cells = [LSTMCell(params.num_units, 0, params.num_layers),
                 LSTMCell(params.num_units, 1, params.num_layers),
                 LSTMCell(params.num_units, 2, params.num_layers),
                 LSTMCell(params.num_units, 3, params.num_layers)]
        ...
        # Decoder RNN
        cells = [LSTMCell(params.num_units, 0, params.num_layers, True),
                 LSTMCell(params.num_units, 1, params.num_layers, True),
                 LSTMCell(params.num_units, 2, params.num_layers, True),
                 LSTMCell(params.num_units, 3, params.num_layers, True)]
...
def main():
    ...
    model = Model(args, params, src_vocab_size, tgt_vocab_size)
