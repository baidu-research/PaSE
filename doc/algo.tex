...
\begin{algorithmic}[1]
	\Procedure{SortNodes}{$G=(V,E)$}

	\LeftComment{For each vertex $v$, assign all its neighbors as its
	unprocessed neighbor set $v.un$.}
	\ForAll{$v \in V$}
